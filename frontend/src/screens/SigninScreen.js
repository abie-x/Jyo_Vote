    ...
    return(
        <div className='signup-parent'>
            <div className="signup-brand">
                ...
                <img src='/images/loginimage.png' className='signin-brand-image'/>
            ...
            <div className='signup-form'>
                ...
                <div className='signup-redirector'>
                    <h5 style={{display: "inline", marginLeft: "4px"}}>Already a member? <Link to={'/'}><h5 style={{fontWeight:800, display: "inline", letterSpacing: "0.75px", cursor: "pointer", color: "#000"}}>Signup</h5></Link></h5>
                </div>
                </div>
            </div>
        </div>
